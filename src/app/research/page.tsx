...
export const metadata: Metadata = { title: 'Research & Publications', description: 'Verified research and publications across technology, cybersecurity, business, and analytics.' }
